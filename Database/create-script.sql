...
CREATE TABLE IF NOT EXISTS `GoodReadsDB`.`address` (
  ...
  UNIQUE INDEX `town_id_UNIQUE` (`adress_id` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `GoodReadsDB`.`users` (
  ...
  INDEX `town_id_idx` (`adress_id` ASC) ,
  UNIQUE INDEX `username_UNIQUE` (`username` ASC) ,
  INDEX `privacy_id_fk_idx` (`privacy_id` ASC) ,
  UNIQUE INDEX `privacy_id_UNIQUE` (`privacy_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `GoodReadsDB`.`users_have_friends` (
  ...
  INDEX `user_id_idx1` (`user_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `GoodReadsDB`.`languages` (
  ...
  UNIQUE INDEX `languag_UNIQUE` (`language` ASC) )
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `GoodReadsDB`.`reading_challenge` (
  ...
  INDEX `participant_id_idx` (`participant_id` ASC) ,
